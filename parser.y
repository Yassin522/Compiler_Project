...
%type <astNode> program params declaration_list declaration function_declaration_type function_declaration_param_statement variable_declaration variable_declaration_list variable_declaration_identifier type_specifier function_declaration compound_statement statement return_statement expression D mutable immutable factor term sum_expression regular_expression unary_relation_expression and_expression simple_expression iterative_statements constant initilization_params
...
declaration_list
			: declaration D 
		       {
      $$ = createASTNode(NODE_DECLARATION_LIST);
      $$->leftChild = $1;
      $$->rightSibling = $2;
...
declaration
			...
			{
				$$ = createASTNode(NODE_DECLARATION);
				$$->leftChild = $1;
				printf("Declaration\n");
				int result = eval($$);
				printf("Result: %d\n", result);
...
variable_declaration
			: type_specifier variable_declaration_list ';'
			 {
				 $$ = createASTNode(NODE_VARIABLE_DECLARATION);
                 $$->leftChild = $1;
                 $$->rightSibling = $2;
...
function_declaration
			...
			{
             $$ = createASTNode(NODE_FUNCTION_DECLARATION);
			 $$->leftChild = $1;
                 $$->rightSibling = $2;
...
function_declaration_param_statement
			: params ')' statement
			{
      $$ = createASTNode(NODE_FUNCTION_DECLARATION_PARAM_STATEMENT);
	  $$->leftChild = $1;
                 $$->rightSibling = $3;
